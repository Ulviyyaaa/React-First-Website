...
import "./index.scss"
function TomAtoCentence() {
  return (
    <section className='mainCeo'>
    <div className='ceoSec'>
      ...
      <div className='tom'>
        <img src='https://dummyimage.com/40x40/ced4da/6c757d' alt='img' />
        <h3> Tom Ato / CEO, Pomodoro</h3>
      </div>
    </div>
  </section>
  )
